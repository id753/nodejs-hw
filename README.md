...
Фільтрація. Використовуючи текстовий індекс MongoDB додано можливість фільтрування колекції нотаток до маршруту GET /notes за тегом та текстом через параметри рядка запиту (search, tag).
Пагінація. Додано можливість пагінації до маршруту GET /notes через параметри рядка запиту (page, perPage).
Валідація. Додано валідацію вхідних даних за допомогою бібліотеки celebrate https://www.npmjs.com/package/celebrate.
